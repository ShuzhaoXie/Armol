...
class PPOBuffer:
    ...
    def __init__(self, obs_dim, act_dim, size, gamma=0.99, lam=0.95):
        self.obs_buf = torch.zeros(core.combined_shape(size, obs_dim), dtype=torch.float32)
        self.act_buf = torch.zeros(core.combined_shape(size, act_dim), dtype=torch.float32)
...
def ppo(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0,
    ...
    def test_agent():
        ...
        epoch_end_map = cal_mAP(TMP_PREDICTED_PATH)

        print('mAP: ', epoch_end_map)
