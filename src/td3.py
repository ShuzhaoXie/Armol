...
import logging
from util import *
from compare import cal_mAP, write_predicted
...
def td3(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
    ...
    def test_agent():
        ...
        for j in range(num_test_episodes):
            ...
            check_exist_dir_path(TMP_PREDICTED_PATH)
            ...
            while not(d or (ep_len == max_ep_len)):
                ...
                predict_file_path = os.path.join(TMP_PREDICTED_PATH, '{}.txt'.format(ep_len))
            ...
            map = cal_mAP(TMP_PREDICTED_PATH)
